    ...
    <div>
      ...
      <div className=" bg-[#fafbff]   rounded-md mx-20 mt-6 px-8 pt-5 pb-2">
        <div className=" grid grid-cols-4 gap-3   ">               {/* dividing homepagee into two sections */}
          <div className=" col-span-3 grid grid-rows-3 gap-3  ">    {/* left Scetion */}

            <div className="grid grid-cols-6 gap-5 ">           {/*dropdown+searchbar goes here*/}
            ...
            <div className="bg-white shadow-sm rounded-md">Chart</div>           {/* chart goes here */}


            <div className="grid grid-cols-2 gap-2">              {/*  Portfolio+exchange*/}
          ...
          <div className=" bg-white shadow-sm rounded-md   ">            {/* //sidebar section// */}
            Sidebar
            {/* <Market /> */}
          </div>
        </div>
